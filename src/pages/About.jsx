...
const AboutUsPage = () => {
  return (
    <Box sx={{ padding: '2rem', maxWidth: '100vw', backgroundColor: '#f4f6f9' }}>
      {/* Project Description */}
      <Box mb={6}>
        <Typography variant="h4" fontWeight="bold" gutterBottom align="center" sx={{ fontSize: '2rem' }}>
          About Kisan Connect
        </Typography>
        <Typography variant="body1" color="text.secondary" align="center" sx={{ fontSize: '1.1rem', lineHeight: 1.7, maxWidth: '800px', mx: 'auto' }}>
      ...
      {/* Developer Profiles */}
      <Box mb={6}>
        <Typography variant="h5" fontWeight="bold" gutterBottom align="center" sx={{ fontSize: '1.8rem' }}>
          Meet Our Developers
        </Typography>
        <Grid container spacing={4} justifyContent="center">
          {developers.map((dev, index) => (
            <Grid item key={index} xs={12} sm={6} md={4}>
              <Card sx={{ maxWidth: 400, padding: '1.5rem', textAlign: 'center' }}>
                <Avatar
                  sx={{ width: 120, height: 120, margin: '0 auto 1rem' }}
                  alt={dev.name}
                  src={dev.image} // Display the developer's image
                />
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ marginBottom: '1rem', fontSize: '1rem' }}>
                    {dev.expertise}
                  </Typography>
                  <Box>
                    <IconButton
                    ...
                    <IconButton
                      ...
                      target="_blank"
                      sx={{ color: '#4267B2', '&:hover': { color: '#365899' } }}
                    >
                      <Facebook />
                    </IconButton>
                    <IconButton
                      ...
                      target="_blank"
                      sx={{ color: '#333', '&:hover': { color: '#24292F' } }}
                    >
                      <GitHub />
                    </IconButton>
                  </Box>
      ...
      <Box mb={6} sx={{ textAlign: 'center' }}>
        ...
        <Grid container spacing={4} justifyContent="center">
          <Grid item xs={12} sm={4}>
            ...
            <Typography variant="body1" sx={{ fontSize: '1.1rem' }}>{technologies.frontend.join(', ')}</Typography>
          </Grid>
          <Grid item xs={12} sm={4}>
            <Typography variant="h6" fontWeight="bold" sx={{ fontSize: '1.2rem' }}>
              Backend
            </Typography>
            <Typography variant="body1" sx={{ fontSize: '1.1rem' }}>{technologies.backend.join(', ')}</Typography>
          </Grid>
          <Grid item xs={12} sm={4}>
            <Typography variant="h6" fontWeight="bold" sx={{ fontSize: '1.2rem' }}>
              Database
            </Typography>
            <Typography variant="body1" sx={{ fontSize: '1.1rem' }}>{technologies.database.join(', ')}</Typography>
          </Grid>
        </Grid>
      </Box>
      ...
      <Box textAlign="center" mb={4}>
        ...
        <Button
          ...
          target="_blank"
          sx={{ margin: '0.5rem', fontSize: '1rem', padding: '0.8rem 2rem' }}
        >
